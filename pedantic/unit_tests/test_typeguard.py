...
class TestCheckArgumentTypes:
    ...
    def test_mismatching_default_type(self):
        ...
        pytest.raises(PedanticTypeVarMismatchException, a=foo)
...
#
#     def test_pedantic_no_annotations(self, recwarn):
#         def foo(a, b):
#             pass
#
#         pedantic(foo)
...
#             'no type annotations present -- not typechecking')
#
